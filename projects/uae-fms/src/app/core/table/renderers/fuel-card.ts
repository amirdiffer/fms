    ...
    <div class=" ">
        <div class="d-inline-flex w-100 py-2 ">
            <button class="border-0 bg-transparent">
                <img *ngIf='OpenedItem'  (click)='OpenedItem=false;' src='assets/icons/plus_fill.svg'  width="18">
                <img *ngIf='!OpenedItem' (click)='OpenedItem=true;' src="assets/icons/plus_square.svg"  width="18">
            </button>
