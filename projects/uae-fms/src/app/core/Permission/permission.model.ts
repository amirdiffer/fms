export class MenuPermission {
  ...
  constructor() {
    ...
    this._fleetPermission = {
      ...
      OPERATOR: ['USER_OPERATOR_VIEW_LIST', 'USER_OPERATOR_ADD'],
      DEPARTMENT: ['ORGANIZATION_VIEW_LIST', 'ORGANIZATION_ADD'],
      MOVEMENT: [
    ...
    this._workshopPermission = {
      ...
      TASKMASTER: ['TASK_MASTER_VIEW_LIST', 'TASK_MASTER_ADD']
    };

    /* '''''Part Store''''' */
    this._partStorePermission = {
      PART_LIST: ['PARTSTORE_PART_VIEW_LIST'],
      ORDER_LIST: [
    ...
    this._configurationPermission = {
      ...
      FLEET_CONFIGURATION: ['FLEET_CONFIGURATION_VIEW_LIST'],
      USAGE_CATEGORY: ['BUSINESS_CATEGORY_VIEW_LIST', 'BUSINESS_CATEGORY_ADD'],
      OWNERSHIP: ['OWNERSHIP_VIEW_LIST', 'OWNERSHIP_ADD'],
      PERIODIC_SERVICE: ['PERIODIC_SERVICE_VIEW_LIST', 'PERIODIC_SERVICE_ADD']
    };
    ...
    switch (parent) {
      ...
      case 'CONFIGURATION':
        let permissionPartConfigurationLabel = {
          ...
          FLEET_CONFIGURATION: this._configurationPermission
            .FLEET_CONFIGURATION,
