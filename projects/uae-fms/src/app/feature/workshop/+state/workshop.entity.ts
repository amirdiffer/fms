import { IAuctionListState, WORKSHOP_AUCTION_LIST_FEATURE_KEY } from "./auction-list/auction-list.entity";
import { WORKSHOP_BODYSHOP_FEATURE_KEY, BodyShopState } from "./body-shop/body-shop.entity";
import { WORKSHOP_TECHNICAL_INSPECTION_FEATURE_KEY , ITechnicalInspectionState } from "./technical-inspections/technical-inspections.entity";
