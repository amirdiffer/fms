...
export interface ITechnicalInspectionState extends EntityState<ITechnicalInspectionModel>{
    error?: any;
    loaded: boolean;
    message: string;
}
...
export const technicalInspectionAdapter: EntityAdapter<ITechnicalInspectionModel> = createEntityAdapter<ITechnicalInspectionModel>();
