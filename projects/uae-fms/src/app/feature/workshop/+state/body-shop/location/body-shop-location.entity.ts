...
export interface IBodyShopLocationState
  extends EntityState<IBodyShopLocationStateModel> {
  error?: any;
  loaded: boolean;
  message: string;
}
...
export const bodyShopLocationAdapter: EntityAdapter<IBodyShopLocationStateModel> = createEntityAdapter<
  IBodyShopLocationStateModel
>();
