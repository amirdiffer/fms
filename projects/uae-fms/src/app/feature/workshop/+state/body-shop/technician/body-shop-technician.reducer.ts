...
import { bodyShopTechnicianAdapter, IBodyShopTechnicianState, initialState } from './body-shop-technician.entity'
...
const bodyShopTechnicianReducer = createReducer(
    ...
    bodyShopTechnicianAdapter.setAll(data, { ...state, loaded: true, error: null })
    ),
