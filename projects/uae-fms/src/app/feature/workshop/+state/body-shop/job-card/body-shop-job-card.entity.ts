...
export interface IBodyshopJobCardState extends EntityState<IBodyshopJobCardStateModel>{
    error?: any;
    loaded: boolean;
    message: string;
}
...
export const bodyShopJobCardAdapter: EntityAdapter<IBodyshopJobCardStateModel> = createEntityAdapter<IBodyshopJobCardStateModel>();
