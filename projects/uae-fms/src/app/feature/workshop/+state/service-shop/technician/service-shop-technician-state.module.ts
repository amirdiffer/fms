...
import {ServiceShopTechnicianService , ServiceShopTechnicianFacade} from "./index"
...
@NgModule({
    imports :[
        StoreModule.forFeature(WORKSHOP_SERVICESHOP_TECHNICIAN_FEATURE_KEY , serviceShopTechnicianReducer.reducer),
