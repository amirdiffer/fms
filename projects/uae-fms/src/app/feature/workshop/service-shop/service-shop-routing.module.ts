...
const routes: Routes = [
  {
    path: '',
    component: ServiceShopComponent,
    pathMatch: 'full',
  ...
  {
    path: 'add-request',
    component: AddRequestServiceShopComponent,
    canActivate: [PermissionGuard],
    data: {
      permission: ['WORKSHOP_SERVICE_SHOP_REQUEST_ADD']
    }
  },
  {
    path: 'add-technician',
    component: AddTechnicianServiceShopComponent,
    canActivate: [PermissionGuard],
    data: {
      permission: ['WORKSHOP_SERVICE_SHOP_TECHNICIAN_ADD']
    }
  },
  {
    path: 'technician/:id',
    component: TechnicianOverviewServiceShopComponent,
    canActivate: [PermissionGuard],
    data: {
  ...
  {
    path: 'add-job-card',
    component: AddJobCardServiceShopComponent,
    canActivate: [PermissionGuard],
    data: {
