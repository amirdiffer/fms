...
export const FLEET_MOVEMENT_TEMPORARY_OVERVIEW_FEATURE_KEY = 'movementOverviewTemporary';
...
export interface MovementOverviewPartialState {
  [FLEET_MOVEMENT_TEMPORARY_OVERVIEW_FEATURE_KEY]: MovementOverviewState;
}
