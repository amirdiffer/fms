...
import { MovementOverviewServiceTemporary , MovementOverviewFacadeTemporary } from "./index";


@NgModule({
    imports:[
        StoreModule.forFeature(FLEET_MOVEMENT_TEMPORARY_OVERVIEW_FEATURE_KEY , movementOverviewReducer.reducer),
