...
import {OperatorMovementHistoryService , OperatorMovementHistoryFacade} from './index'
@NgModule({
    imports:[
        StoreModule.forFeature(FLEET_OPERATOR_MOVEMENT_HISTORY_FEATURE_KEY , operatorMovementReducer.reducer),
