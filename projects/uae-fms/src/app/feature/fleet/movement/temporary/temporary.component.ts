...
export class TemporaryComponent implements OnInit, AfterViewChecked {
  ...
  ngOnInit(): void {
    ...
    this.movementOverViewTableSetting = this._movementService.movementTemporaryOverViewTableSetting();
