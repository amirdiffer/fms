    ...
    this.loginService
      ...
      .subscribe(
        () => {
          ...
          window.localStorage.setItem('routingKey', 'vehicles');
          window.localStorage.setItem(
            'ANMS-SETTINGS',
            JSON.stringify({
              language: 'en',
          ...
          window.localStorage.setItem(
            'loggedUserData',
            JSON.stringify({
              userEmployeeId: '41613',
              userFullName: 'الاسم بالكامل',
              userEmail: 'emailAddress41613@dp.com',
              userImageForMobile:
                '',
              userMobileNumber: '01038738475341613',
              accessToken:
                'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTczOTc5NDQyNSwiaWF0IjoxNjEzNjUwNDI1LCJhdXRob3JpdGllcyI6W3siYXV0aG9yaXR5IjoiUk9MRV9BRE1JTiJ9XX0.ESY3tmZSx45ZkzYs5NwMOzHm1tHHlk4nqwwXFntNfpYONdSUkivoVO2bpDjbZEdksKS6W4BPDrOuWdSMbU8R2g',
              userId: 1,
              verificationCode: 7536
            })
          );
          window.localStorage.setItem(
            'accessToken',
          ...
          this.profileSubscribtion = this.profileFacade.loadData$.subscribe(
            (x) => {
              if (x) {
                if (x.roles[0].roleId === 2) {
                  this.router.navigate(['/dashboard/technician']).then((x) => {
                    if (x) this.profileSubscribtion.unsubscribe();
                  });
                } else {
                  this.router.navigate(['/dashboard']).then((x) => {
                    if (x) this.profileSubscribtion.unsubscribe();
                  });
                }
              }
