...
const routes: Routes =[
    ...
    {
        path: 'asset', component: OrderListComponent,
    ...
    {
        path: 'sub-asset', component: OrderListComponent,
        canActivate:[PermissionGuard],
        data:{
          permission:[
            "PARTSTORE_ORDER_LIST_REQUEST_VIEW_LIST_OWN",
    ...
    {
        path: ':fleetType/edit-order/:id', component: OrderComponent,
        canActivate:[PermissionGuard],
        data:{
          permission:[
    ...
    {
        path: 'add-supplier', component: SuppliersAddFormComponent,
        canActivate:[PermissionGuard],
        data:{
          permission:[
            "PARTSTORE_SUPPLIER_ADD",
