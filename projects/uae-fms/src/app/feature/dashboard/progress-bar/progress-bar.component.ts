...
export class ProgressBarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._renderer.setStyle(this.progressBar.nativeElement, 'width',`${this.percent}%`)
    this._renderer.setStyle(this.progressBar.nativeElement, 'background-color',`${this.color}`)
