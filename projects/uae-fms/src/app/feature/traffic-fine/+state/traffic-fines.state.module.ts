...
import { AssetTrafficFineService , AssetTrafficFineFacade } from './asset-traffic-fine/index';
...
@NgModule({
  ...
  providers: [TrafficFineTableService, TrafficFineTableFacade , AssetTrafficFineService , AssetTrafficFineFacade]
})
