...
export interface IAssetTrafficFineState
  extends EntityState<IAssetTrafficFineStateModel> {
  error?: any;
  loaded?: boolean;
  message?: string;
}
...
export const assetTrafficFineAdapter: EntityAdapter<IAssetTrafficFineStateModel> = createEntityAdapter<
  IAssetTrafficFineStateModel
>();
