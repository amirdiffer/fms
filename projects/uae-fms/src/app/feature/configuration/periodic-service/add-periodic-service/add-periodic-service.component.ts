    ...
    return {
      ...
      packages: packages.map((p) => {
        return {
          ...
          durationTypeForReminder: p.durationButton
            ? p.durationTypeForReminder
            : null,
